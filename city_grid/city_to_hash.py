...
#adapted from https://github.com/mathieuripert/geoh
...
def geohashes(polygon, precision=6, start_precision=2):
  """
    Return the list of geohashes that interects the polygon.
  """
  if not polygon:
    return []
