...
if __name__ == "__main__":
    ...
    H = nx.read_gml(directory+"inf_dartmouth_01-10-02.gml")
    print("computing support power")
    support = power.power_support_influence(H)
    file_name = "support_dartmouth_01-10-02.gml"
    ...
    file_name = "attract_dartmouth_01-10-02.gml"
    print('saving graph %s' % file_name)
    nx.write_gml(attract, directory + file_name)
    file_name = "dartmouth_01-10-02.csv"